...
;; If it is non-nil, then `C-z' runs lc-complete-a-la-mode.
;;
...
(defcustom lc-ctrl-backslash-completes-a-la-mode nil
  "Toggle whether `C-z' runs the `completing-insert-according-to-mode'.
If turned off, `C-z' does nothing."
  :type '(boolean)
  :set (lambda (symbol value)
	 (if value
	     (global-set-key "\C-z" 'completing-insert-according-to-mode)
