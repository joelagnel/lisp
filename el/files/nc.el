...
(defvar nc-highlight-foreground-color "SteelBlue"
  "*Foreground of Cursor and Title")
(defvar nc-select-foreground-color "Black"
  "*Background of selection mark")
(defvar nc-select-background-color "Yellow"
...
(defvar nc-show-shell nil		; Unfinished
