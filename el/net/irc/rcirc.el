...
;; Copyright (C) 2005  Ryan Yeske <rcyeske@gmail.com>

;; Author: Ryan Yeske
;; X-RCS: $Id: rcirc.el,v 1.287 2005/10/17 09:53:19 rcyeske Exp $
...
(defvar rcirc-server "irc.xworld.org"
...
If optional argument HERE is non-nil, insert string at point."
  (interactive "P")
  (let ((version "rcirc.el 0.9 $Revision: 1.287 $"))
    (if here
        (insert version)
      (if (interactive-p)
          (message "%s" version)
