(setq erc-load-path "~/lisp/erc/")
(add-to-list 'load-path erc-load-path)
...
(defvar erc-start-list
  '(("irc.debian.org" 6667  "Lathi")
    ;("irc.kernelnewbies.org" 6667 "Lathi")
    ;("localhost" 6667 "Lathi")
    )
...
(setq erc-away-nickname "LathiAway")
(setq erc-log-channels t)
(setq erc-log-channels-directory "/home/dalcorn/data/irc-logs")
...
(setq erc-echo-timestamps t)
(setq erc-user-full-name "Doug Alcorn")
...
; ignores
;(setq erc-ignore-list '("tsp.*\\.hsia\\.telus\\.net"))
;(setq erc-fools '("tsp"))
