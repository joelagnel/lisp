...
;; Version: $Header: /home/gd/gnu/emacs/19.0/lisp/RCS/metamail.el,v 1.1 1993/07/20 03:02:12 rms Exp $
...
redisplayed as output is inserted."
  ...
  (let ((curbuf (current-buffer))
	...
	(delete-region (point-min) (point-max)))
      ...
      ;; XXX HACK HACK ckd@kei.com 930921
      ;; (from lemacs 19.8 comint.el to support MAINTAIN_ENVIRONMENT
      ;; not perfect but works better than the alternative, heh
	...
	(let ((keyheadsv (getenv "KEYHEADS")))
	  (unwind-protect
	      (progn (setenv "KEYHEADS" "*")
		     (apply (function call-process)
			    metamail-program-name
			    nil
			    t			;Output to current buffer
