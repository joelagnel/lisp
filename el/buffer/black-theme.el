...
(defun color-theme-cl-frame ()
  ...
  (color-theme-install
   '(color-theme-cl-frame
     ...
     (font-lock-comment-face ((t (:background "gray29" :foreground "gray60" :width semi-condensed :family "helvetica"))))
     (font-lock-constant-face ((t (:foreground "LightGreen" :family "outline-lucida sans typewriter" :height 1.0))))
     ...
     (font-lock-function-name-face ((t (:bold t :foreground "Steelblue1" :height 141))))
     (font-lock-interface-def-face ((t (nil))))
     (font-lock-keyword-face ((t (:bold t :foreground "#40AA3D" :family "outline-lucida sans typewriter" :height 0.9))))
     ...
     (font-lock-string-face ((t (:foreground "gray60" :family "outline-lucida sans typewriter" :height 0.9))))
     (font-lock-type-def-face ((t (nil))))
     (font-lock-type-face ((t (:foreground "#66758A" :family "outline-lucida sans typewriter" :height 0.9))))
