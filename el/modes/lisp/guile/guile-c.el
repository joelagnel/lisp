...
;; GNU Lispers Club - Bangalore India
...
;;; Commentary:
;;  This is for editing guile interpreter code in C-mode
...
;;     (define-key c-mode-map "\C-c\C-g\C-d" 'scmc)
;;     ))
...
(defun scmc (name &optional use-gh)
