...
(put 'org-agenda-timeline 'custom-loads '(org))
...
(put 'calendar 'custom-loads '(calendar solar icalendar midnight org todo-mode))
...
(put 'mule 'custom-loads '(descr-text kkc latexenc mule-diag))
