(defun color-theme-dark-steel ()
  ...
  (color-theme-install
   '(color-theme-dark
     ...
     (default ((t (:stipple nil :background "gray30" :foreground "gray80" :inverse-video nil :box nil :strike-through nil :overline nil :underline nil :slant normal :weight normal :height 100 :width normal :family "misc-fixed"))))

     (Buffer-menu-buffer ((t (nil))))
     (Info-title-1-face ((t (:bold t :weight bold :height 1.728 :family "monospace"))))
     (Info-title-2-face ((t (:bold t :weight bold :height 1.44 :family "monospace"))))
     (Info-title-3-face ((t (:bold t :weight bold :height 1.2 :family "monospace"))))
     (Info-title-4-face ((t (:bold t :weight bold :family "monospace"))))
     ...
     (cperl-hash-face ((t (:foreground "AquaMarine"))))
...
;; dired
     ...
     (dired-directory ((t (:bold t :foreground "steelblue3" :weight bold))))
     ...
     (linkd-command-face ((t (:foreground "gold" :background "steelblue4"))))
     ...
     (fg:erc-color-face10 ((t (:foreground "pale steelblue"))))
     (fg:erc-color-face11 ((t (:foreground "steelblue"))))
     (fg:erc-color-face12 ((t (:foreground "light yellow"))))
     (fg:erc-color-face13 ((t (:foreground "Steelblue1"))))
     (fg:erc-color-face14 ((t (:foreground "light steelblue"))))
     ...
     (fl-keyword-face ((t (:bold t :foreground "LightGreen"))))
...
;; code syntax highlighting
     ...
     (font-lock-comment-delimiter-face ((t (:background "black" :foreground "RoyalBlue1"))))
     (font-lock-comment-face ((t (:background "black" :foreground "RoyalBlue1" :width semi-condensed :family "monospace"))))
     (font-lock-constant-face ((t (:foreground "chocolate1" :family "monospace" ))))
     ...
     (font-lock-function-name-face ((t (:bold t :foreground "Steelblue1" :height 100))))
     (font-lock-interface-def-face ((t (nil))))
     (font-lock-keyword-face ((t (:bold t :foreground "SpringGreen4" :family "outline-lucida sans typewriter" ))))
     (font-lock-module-def-face ((t (nil))))
     (font-lock-reference-face ((t (:foreground "Lime green"))))
     ...
     (font-lock-string-face ((t (:foreground "gray60" :family "outline-lucida sans typewriter" ))))
     (font-lock-type-def-face ((t (nil))))
     (font-lock-type-face ((t (:foreground "DarkSteelblue1" :family "outline-lucida sans typewriter" ))))
...
;;; gnus
     ...
     (hi-black-hb ((t (:bold t :weight bold :height 1.67 :family "monospace"))))
...
;;
     ...
     (jde-java-font-lock-api-face ((t (:foreground "light steelblue"))))
     ...
     (minibuffer-prompt ((t (:foreground "Steelblue1" :background "black" :weight bold))))
...
;; mode-line
     ...
     (org-time-grid ((t (:foreground "LightSteelblue"))))
     ...
     (outline-2 ((t (:italic t :bold t :foreground "LightSteelblue" :slant italic :weight bold))))
...
;; paren-match
     ...
     (paren-mismatch ((t (:background "Brown" :foreground "gray30"))))
     ...
     (rcirc-dim-nick ((t (:stipple nil :background "saddlebrown" :foreground "orange" :inverse-video nil :box nil :strike-through nil :overline nil :underline nil :slant normal :weight normal :height 98)))) ; 98
     (rcirc-keyword ((t (nil))))
...
(provide 'color-theme-dark-steel)
