;;; Saved through ges-version 0.3.3dev at 2003-08-12 09:49
;;; ;;; From:  Jesper Harder <harder@myrealbox.com>
;;; ;;; Subject: keywiz.el 1.4 --- Emacs key sequence quiz
;;; ;;; Newsgroups: gnu.emacs.sources
;;; ;;; Date: Sun, 10 Aug 2003 18:36:16 +0200
...
;;; >
;;; >> keywiz.el drills you about Emacs key-bindings.
;;; >
;;; > Nice.  It appears to use the current key map to find out when a key
;;; > sequence "ends", or something.  E.g., for a Gnus command 'G S l' when
;;; > I press 'G' it says 'G' was wrong without allowing me to input 'S l'.

;;; Yup, it needs to copy the current keymaps to the keywiz buffer (fixed
;;; version below).

;;; > replies.. and my emacs cannot input ~ for some reason, so I had to
;;; > fail some questions.)

;;; I assume `~' is a dead key on you keyboard -- the dead keys have been
;;; broken for a while in cvs.  It helps to load `iso-transl' (`C-x 8').
