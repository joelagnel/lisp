...
;; (defun emacswiki-rc ()
;;   (interactive)
;;   (simple-wiki-rc "http://www.emacswiki.org/cgi-bin/wiki.pl" 1)
;;  )
;;then M-x emacswiki-rc RET for Recent Changes during last day
;;other example
;;(defun gnufans-rc ()
;;   (interactive)
;;   (simple-wiki-rc "http://www.gnufans.net/cgi-bin/fsedu.pl" 7)
;;  )
...
(defun simple-wiki-rc (base &optional days)
  "present a simple recent changes list"
   ...
   (let* ( 
     ...
     (set (make-local-variable 'simple-wiki-save-function) 'simple-wiki-rc-save) 
