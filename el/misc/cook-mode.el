...
;; This is version 1.0 as of 04 May 2005
...
; Variables
; (regexp-opt '("@1" "@2" "@3" "@4" "@5" "@6" "@7" "@8" "@9" "arg" "command-line-goals" "__FILE__" "__FUNCTION__" "graph_leaf_file" "graph_exterior_file" "graph_interior_file" "graph_leaf_pattern" "graph_exterior_pattern" "graph_interior_pattern" "__LINE__" "need" "parallel_hosts" "parallel_jobs" "parallel_rsh" "search_list" "self" "target" "targets" "thread-id" "younger" "version") t)
...
(defvar cook-mode-font-lock-keywords
  '(
    ...
    ("\\(@[1-9]\\|__\\(?:\\(?:F\\(?:ILE\\|UNCTION\\)\\|LINE\\)__\\)\\|arg\\|command-line-goals\\|graph_\\(?:exterior_\\(?:file\\|pattern\\)\\|interior_\\(?:file\\|pattern\\)\\|leaf_\\(?:file\\|pattern\\)\\)\\|need\\|parallel_\\(?:hosts\\|jobs\\|rsh\\)\\|se\\(?:arch_list\\|lf\\)\\|t\\(?:argets?\\|hread-id\\)\\|version\\|younger\\)"
