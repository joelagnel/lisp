...
;;;; Subject: re-builder 1.2 - Building Regexps with visual feedback
;;;; Date: 13 Jan 2000 00:00:00 GMT
;;;; Message-ID: <87puv66dxt.fsf@magrathea.outer.space.org>
;;;; X-Server-Date: 12 Jan 2000 23:57:35 GMT
;;;; Content-Type: text/plain; charset=US-ASCII
;;;; X-Complaints-To: usenet@rz.uni-karlsruhe.de
;;;; X-Trace: news.rz.uni-karlsruhe.de 947721769 8320 129.13.216.201
;;;; Organization: Church of Emacs - Missionary division
;;;; Mime-Version: 1.0 (generated by tm-edit 7.106)
;;;; Newsgroups: gnu.emacs.sources
;;;; X-Tom-Swiftie: "Be sure to add that host to the DNS," Tom said authoritatively

;;;; Hi,

;;;; as suggested by RMS the user interface of `re-builder' has been
;;;; simplified.  Instead of having to explicitly ask for updates they will
;;;; be done automatically while editing, making it work somewhat like
;;;; isearch for regexps with color marking...

;;;; As was pointed out to me there is already a package in GNU/Emacs
;;;; implementing symbolic (lispy) regexps by Bob Glickstein (sregex) so
;;;; support for this has also been added.

;;;; If you could test it somewhat and do find bugs please let me know as
;;;; `re-builder' might make into GNU/Emacs so I can fix them as early as
;;;; possible.

;;;; This was tested only on GNU/Emacs but I incorporated a patch supplied
;;;; by Ulrich Kaage (against the old version) that should make it work for
;;;; XEmacs also.  If the new version breaks different things on those
;;;; Emacsen let me know.
