...
;; $Id: honest-report.el,v 1.5 2006/03/22 13:29:25 hira Exp $
;;
  ...
  (remove nil
          `(
            ("Emacs" . ,(format "%s (%s) of %s"
                              ...
                              (howm-emacs-build-time)))
            ("system" . ,system-type)
            ("window system" . ,window-system)
            ,(and (fboundp 'Meadow-version)
                  (cons "Meadow" (howm-funcall-if-defined (Meadow-version))))
            )))
